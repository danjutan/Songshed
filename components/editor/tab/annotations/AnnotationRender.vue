...
import { injectAnnotationResizeState } from "~/components/editor/tab/providers/state/provide-annotation-resize-state";
import { injectAnnotationAddState } from "~/components/editor/tab/providers/state/provide-annotation-add-state";
import { injectAnnotationHoverState } from "~/components/editor/tab/providers/state/provide-annotation-hover-state";
import AnnotationResizeHandle from "~/components/editor/tab/annotations/AnnotationResizeHandle.vue";
