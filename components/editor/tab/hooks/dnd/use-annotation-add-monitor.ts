...
import type { AnnotationAddState } from "~/components/editor/tab/providers/state/provide-annotation-add-state";
import { isAnnotationDragData } from "~/components/editor/tab/hooks/dnd/dnd-types";
