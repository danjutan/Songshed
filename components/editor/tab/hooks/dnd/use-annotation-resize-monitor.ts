...
import { isAnnotationDragData, isAnnotationResizeDragData } from "~/components/editor/tab/hooks/dnd/dnd-types";
import type { AnnotationResizeState } from "~/components/editor/tab/providers/state/provide-annotation-resize-state";
