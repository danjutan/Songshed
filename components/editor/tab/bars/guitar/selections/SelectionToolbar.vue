...
import MoveDragger from "~/components/editor/tab/bars/guitar/selections/MoveDragger.vue";
...
import { injectCopyState } from "~/components/editor/tab/providers/state/provide-copy-state";
