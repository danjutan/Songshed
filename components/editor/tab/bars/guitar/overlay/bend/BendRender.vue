...
import { injectBendEditState } from "~/components/editor/tab/providers/state/provide-bend-edit-state";
import OverlayCoords from "~/components/editor/tab/bars/OverlayCoords.vue";
import OverlaySelect from "~/components/editor/tab/bars/guitar/overlay/OverlaySelect.vue";
import { injectOverlayControlsTeleport } from "~/components/editor/tab/bars/guitar/providers/provide-overlay-controls-teleport";
...
import BendDragger from "~/components/editor/tab/bars/guitar/overlay/bend/BendDragger.vue";
