...
import TieCurve from "~/components/editor/tab/bars/guitar/overlay/tie/TieCurve.vue";
import TieSelect from "~/components/editor/tab/bars/guitar/overlay/tie/TieSelect.vue";
