...
import NoteContainer from "~/components/editor/tab/bars/guitar/stack/NoteContainer.vue";
import { injectStackResizeObserver } from "~/components/editor/tab/providers/events/provide-resize-observer";
import { useIsCollapsed } from "~/components/editor/tab/hooks/use-collapsed";
...
import { injectTimeSignature } from "~/components/editor/tab/providers/provide-time-signature";
