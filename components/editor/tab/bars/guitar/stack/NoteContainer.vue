...
import NoteInput from "~/components/editor/tab/bars/guitar/stack/NoteInput.vue";
import { injectSelectionState } from "~/components/editor/tab/providers/state/provide-selection-state";
import { injectEditingState } from "~/components/editor/tab/providers/state/provide-editing-state";
...
import NoteTieDragger from "~/components/editor/tab/bars/guitar/stack/NoteTieDragger.vue";
...
import { injectNotePreviewState } from "~/components/editor/tab/providers/state/provide-note-preview-state";
...
import PositionLine from "~/components/editor/tab/bars/guitar/stack/PositionLine.vue";
