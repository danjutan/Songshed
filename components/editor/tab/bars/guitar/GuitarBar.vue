...
import { injectTieAddState } from "~/components/editor/tab/providers/state/provide-tie-add-state";
import { injectSubUnitFunctions } from "~/components/editor/tab/providers/provide-subunit";
import { provideEditTie } from "~/components/editor/tab/bars/guitar/providers/provide-edit-tie";
import { provideOverlayControlsTeleport } from "~/components/editor/tab/bars/guitar/providers/provide-overlay-controls-teleport";

import BendRender from "~/components/editor/tab/bars/guitar/overlay/bend/BendRender.vue";
import TieRender from "~/components/editor/tab/bars/guitar/overlay/tie/TieRender.vue";
import StringLine from "~/components/editor/tab/bars/guitar/stack/StringLine.vue";
import Stack from "~/components/editor/tab/bars/guitar/stack/Stack.vue";
import WidgetStack from "~/components/editor/tab/bars/guitar/stack/widgets/WidgetStack.vue";
import SelectionToolbarRegions from "~/components/editor/tab/bars/guitar/selections/SelectionToolbarRegions.vue";
import BendDroppable from "~/components/editor/tab/bars/guitar/overlay/bend/BendDroppable.vue";
import type { BarHighlightType } from "~/components/editor/tab/bars/TabBar.vue";
