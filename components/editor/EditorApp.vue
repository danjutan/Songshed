...
import Toolbar from "~/components/editor/tab/settings/SettingsBar.vue";
import Tab from "~/components/editor/tab/Tab.vue";
import ChordGroup from "~/components/editor/chords/ChordGroup.vue";
import {
  injectSettingsState,
  provideSettingsState,
} from "~/components/editor/providers/provide-settings-state";
import { provideSpacings } from "~/components/editor/providers/provide-spacings";
